...
int main(int argc, const char **argv) {
  ...
  // RoutePlanner object below in place of 10, 10, 90, 90. - Done
  float start_x;
  float start_y;
  float end_x;
  float end_y;

  std::cout << "Pick starting x coord\n";
  cin >> start_x;
  std::cout << "Pick starting y coord\n";
  cin >> start_y;
  std::cout << "Pick end x coord\n";
  cin >> end_x;
  std::cout << "Pick end y coord\n";
  cin >> end_y;
